...
> 面向**面试 / 复习**的前端知识精讲 · 17 个板块 · 130 篇 · 约 33 万字

[![在线阅读](https://img.shields.io/badge/在线阅读-Live-3c8772)](https://sq-zhong.github.io/frontend-interview/)
[![License](https://img.shields.io/badge/License-CC%20BY--SA%204.0-lightgrey)](./LICENSE)

📖 **在线站(可搜索、暗色模式、手机可刷)→ https://sq-zhong.github.io/frontend-interview/**

## 内容与模板

- **八股地基**(HTML / CSS / JS / React / Vue / 网络 / 浏览器 / TS / 工程化 / 算法 / 手写):五段式 —— 一句话考点 → 原理精讲 → 代码示例 → 高频追问 → 背诵版
- **框架 / 全栈**:Next.js、Node.js/BFF 专题
- **实战**(场景排错 / 业务轮子 / 系统设计):各用贴合场景的模板(排查路径、核心实现、架构设计)
- **AI 时代专题**:从大模型接入到应用架构

> 能力金字塔:**八股(通过初筛)→ 场景排错 + 业务轮子(证明能干活)→ 项目表达 + 系统设计(决定 offer 层级)→ AI 专题(时代差异化)**
...
| # | 标题 | 热度 |
|---|------|------|
| [A1](./algorithm/A1-排序算法.md) | 排序算法(快排/归并) | 🔥🔥 |
| [A2](./algorithm/A2-二分查找.md) | 二分查找 | 🔥🔥 |
| [A3](./algorithm/A3-双指针与滑动窗口.md) | 双指针与滑动窗口 | 🔥🔥🔥 |
| [A4](./algorithm/A4-链表.md) | 链表 | 🔥🔥🔥 |
| [A5](./algorithm/A5-二叉树遍历.md) | 二叉树遍历 | 🔥🔥🔥 |
| [A6](./algorithm/A6-DFS与BFS.md) | DFS 与 BFS | 🔥🔥 |
| [A7](./algorithm/A7-动态规划.md) | 动态规划 | 🔥🔥🔥 |
| [A8](./algorithm/A8-回溯与经典高频题.md) | 回溯与经典高频题 | 🔥🔥 |
...
> 前面是"八股"(知识点),这一板块是"实战"——给你一个坏场景,考你怎么定位、怎么权衡、怎么根治。采用实战模板:**现象 → 排查路径 → 常见根因 → 解决 → 举一反三(面试如何表达)**。

| # | 标题 | 热度 |
|---|------|------|
| [S1](./scenario/S1-页面白屏排查.md) | 页面白屏排查 | 🔥🔥🔥 |
| [S2](./scenario/S2-页面卡顿与性能定位.md) | 页面卡顿与性能定位 | 🔥🔥🔥 |
| [S3](./scenario/S3-内存泄漏定位.md) | 内存泄漏定位 | 🔥🔥 |
| [S4](./scenario/S4-请求问题排查.md) | 请求问题排查(慢/竞态/失败) | 🔥🔥🔥 |
| [S5](./scenario/S5-发布后缓存不更新.md) | 发布后缓存不更新 | 🔥🔥🔥 |
| [S6](./scenario/S6-框架数据不更新.md) | 框架数据不更新(响应式失效) | 🔥🔥🔥 |
| [S7](./scenario/S7-线上错误监控与偶现bug.md) | 线上错误监控与偶现 bug 定位 | 🔥🔥 |
| [S8](./scenario/S8-样式错乱与移动端兼容.md) | 样式错乱与移动端兼容 | 🔥🔥 |

## 板块十三:业务级手写轮子(实战)

> 比手撕算法更贴近真实开发——从零实现工程里真正会用的轮子。采用实现型模板:**需求场景 → 设计要点 → 核心实现 → 使用 → 进阶考点**。

| # | 标题 | 热度 |
|---|------|------|
| [W1](./widgets/W1-手写useRequest数据请求Hook.md) | useRequest 数据请求 Hook | 🔥🔥🔥 |
| [W2](./widgets/W2-手写虚拟列表组件.md) | 虚拟列表组件 | 🔥🔥🔥 |
| [W3](./widgets/W3-手写迷你请求库.md) | 迷你请求库(拦截器/重试/取消/缓存) | 🔥🔥🔥 |
| [W4](./widgets/W4-手写迷你状态管理.md) | 迷你状态管理(发布订阅) | 🔥🔥 |
| [W5](./widgets/W5-手写useForm表单校验.md) | useForm 表单管理与校验 | 🔥🔥 |
| [W6](./widgets/W6-手写并发控制与任务调度.md) | 并发控制与任务调度 | 🔥🔥🔥 |
| [W7](./widgets/W7-手写无限滚动与懒加载Hook.md) | 无限滚动与懒加载 Hook | 🔥🔥 |
| [W8](./widgets/W8-手写大文件分片上传.md) | 大文件分片上传 | 🔥🔥🔥 |

## 板块十四:项目表达 + 系统设计(拿高级 offer 的关键)

> 决定 offer 层级、也最少人准备好的部分。前两篇讲怎么把项目讲出彩,后六篇是高频前端系统设计题。

| # | 标题 | 热度 |
|---|------|------|
| [D1](./design/D1-用STAR讲好项目经历.md) | 用 STAR 讲好项目经历 | 🔥🔥🔥 |
| [D2](./design/D2-项目深挖应对与技术亮点提炼.md) | 项目深挖应对与技术亮点提炼 | 🔥🔥🔥 |
| [D3](./design/D3-前端系统设计答题框架.md) | 前端系统设计答题框架 | 🔥🔥🔥 |
| [D4](./design/D4-设计前端监控SDK.md) | 设计前端监控 SDK | 🔥🔥🔥 |
| [D5](./design/D5-微前端架构设计.md) | 微前端架构设计 | 🔥🔥 |
| [D6](./design/D6-设计低代码搭建平台.md) | 设计低代码/可视化搭建平台 | 🔥🔥 |
| [D7](./design/D7-设计组件库与设计系统.md) | 设计组件库/设计系统 | 🔥🔥 |
| [D8](./design/D8-设计前端权限系统.md) | 设计前端权限系统 | 🔥🔥 |

## 板块十五:AI 时代专题(2026 差异化)

> 大模型正从"加分项"变"标配"。这一板块覆盖前端做 AI 应用的完整链路,是拉开差距的时代性内容。

| # | 标题 | 热度 |
|---|------|------|
| [AI1](./ai/AI1-前端接入大模型基础.md) | 前端接入大模型基础 | 🔥🔥🔥 |
| [AI2](./ai/AI2-SSE流式渲染.md) | SSE 流式渲染 | 🔥🔥🔥 |
| [AI3](./ai/AI3-Markdown流式渲染与打字机.md) | Markdown 流式渲染与打字机 | 🔥🔥 |
| [AI4](./ai/AI4-FunctionCalling与工具调用.md) | Function Calling 与工具调用 | 🔥🔥🔥 |
| [AI5](./ai/AI5-RAG检索增强生成.md) | RAG 检索增强生成 | 🔥🔥🔥 |
| [AI6](./ai/AI6-AI辅助编码工程实践.md) | AI 辅助编码工程实践 | 🔥🔥🔥 |
...
9. **算法**:A3 双指针/滑窗、A4 链表、A5 二叉树、A7 动态规划、A8 回溯
10. **冲刺**:X1 手写合集、X2 输出题专项(临场高频)
11. **拉开差距**:S 系列场景排错专项 —— 把前面的八股盘活成能落地的工程能力,中高级岗必看
12. **证明能干活**:W 系列业务级手写轮子(useRequest / 虚拟列表 / 请求库 / 大文件上传等)
13. **决定层级**:D 系列项目表达(STAR / 深挖应对)+ 前端系统设计(监控 / 微前端 / 低代码 / 组件库 / 权限)
14. **时代差异化**:AI 系列(大模型接入 / SSE 流式 / Function Calling / RAG / AI 辅助编码 / 提示词 / 架构成本安全)

---

## 📄 许可证

本项目内容采用 [**CC BY-SA 4.0**](./LICENSE)(知识共享 署名-相同方式共享)许可协议。

你可以自由地**分享、转载、修改、商用**,但需遵守:

- **署名(BY)**:注明原作者并链接回本仓库;
- **相同方式共享(SA)**:基于本内容的衍生作品须以相同许可证发布。
